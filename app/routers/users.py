...
@router.post('/', response_model=User, status_code=201, tags=["Users"], summary="Criar Usuário")
...
@router.get('/{user_id}', response_model=User, tags=["Users"], summary="Buscar Usuário por ID")
...
@router.put('/{user_id}', response_model=User, tags=["Users"], summary="Atualizar Usuário")
