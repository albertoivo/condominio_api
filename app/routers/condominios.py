...
@router.get('/', response_model=List[Condominio], tags=["Condominios"], summary="Listar Condomínios")
...
@router.post('/', status_code=201, response_model=Condominio, tags=["Condominios"], summary="Criar Condomínio")
...
@router.get('/{condominio_id}', response_model=Condominio, tags=["Condominios"], summary="Buscar Condomínio por ID")
...
@router.delete('/{condominio_id}', status_code=204, tags=["Condominios"], summary="Remover Condomínio")
...
@router.put('/{condominio_id}', response_model=Condominio, tags=["Condominios"], summary="Atualizar Condomínio")
def update_condominio(condominio_id: int, condominio_data: CondominioCreate, db: Session = Depends(get_db)):
    """
    ...
    updated_condominio = condominio_service.update_condominio(condominio_id, condominio_data)
